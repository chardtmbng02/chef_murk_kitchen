  ...
  return (
    <main className="w-full">
      <div className="flex flex-col justify-center items-center border-gray-200">
        ...
        <p className="text-3xl font-bold text-center pb-4 murk-text-secondary">Sign Up Now</p>
        <p className="text-1xl text-center pb-3">It's free and only takes a minute</p>
          ...
          <div className="flex flex-col space-y-6">
            ...
            <input className="w-full px-4 py-3 rounded-lg ring-red-400 focus:ring-4 focus:outline-none transition duration-300 border border-gray-300 focus:shadow-xl" type="password" placeholder="Verify Password" name="verify-password"/>
            <input className="w-full px-4 py-3 rounded-lg ring-red-400 focus:ring-4 focus:outline-none transition duration-300 border border-gray-300 focus:shadow-xl" type="text" placeholder="Firstname" name="firstname"/>
            <input className="w-full px-4 py-3 rounded-lg ring-red-400 focus:ring-4 focus:outline-none transition duration-300 border border-gray-300 focus:shadow-xl" type="text" placeholder="Lastname" name="lastname"/>
          </div>
